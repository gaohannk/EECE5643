...
class Ex1 {
    ...
    try {
      ...
      while ( (line = in.readLine()) != null ) {
        ...
        sum.wait    += wait;
        sum.service += service;
        //the number of jobs in the service node at a specified time
      ...
      System.out.println("a) maximum delay.............=  "+  f.format(maxDelay));
      // Add for homework
      System.out.println("b) the number of jobs in the service node at a specified time ="+  jobInServerNode);
      System.out.println("c) the proportion of jobs delayed ="+ f.format((double) numOfDelay/index));
